 ...
 */
public class MsDbWeatherRecordsLoader implements WeatherRecordsLoader {
   ...
   * @param em
   */
  public MsDbWeatherRecordsLoader(EntityManager em) {
    this.em = em;
  }
  ...
  public WeatherRecords loadWeatherRecords(Set<String> stations, SimulationTimeConfig simulationTimeConfig) {
    ...
    Set<WeatherRecord> records = this.em
      .createNamedQuery("WeatherRecordMsEntity.findByStationsAndDateRange", Object[].class)
