...
@NamedQueries({
  @NamedQuery(name = "ConductorPgEntity.findAll", query = "SELECT s FROM ConductorPgEntity s")})
public class ConductorPgEntity implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    final ConductorPgEntity other = (ConductorPgEntity) obj;
