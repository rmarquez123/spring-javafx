 ...
 */
public class MsDbLineSectionsLoader implements LineSectionsLoader {
   ...
   * @param em
   */
  public MsDbLineSectionsLoader(EntityManager em) {
    this.em = em;
  }
  ...
  public LineSections loadLineSections() {
    List<LineSection> lineSections = this.em
      .createNamedQuery("LineSectionMsEntity.findAll", LineSectionPgEntity.class)
      .getResultList()
      .stream()
      .map((e)->{
