...
import com.windsim.wpls.db.core.ms.entities.ConductorMsEntity;
 ...
 */
public class MsDbConductorsLoader implements ConductorsLoader{
   ...
   * @param em
   */
  public MsDbConductorsLoader(EntityManager em) {
    this.em = em;
  }
  ...
  public ConductorCatalogue loadConductors() {
    List<Conductor> conductors = this.em
      .createNamedQuery("ConductorMsEntity.findAll", ConductorMsEntity.class)
      .getResultList()
      .stream()
      .map((e)->{
