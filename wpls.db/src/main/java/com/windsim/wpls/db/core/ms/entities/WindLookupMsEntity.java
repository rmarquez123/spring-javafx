...
@NamedQueries({
  @NamedQuery(name = "WindLookupMsEntity.findAll", query = "SELECT s FROM WindLookupMsEntity s"), 
  @NamedQuery(name = "WindLookupMsEntity.findByModelPointIdAndSectorNum", 
    query = "SELECT s FROM WindLookupMsEntity s where s.modelPointId = :modelpoint_id and s.sectorNum = :sector_num"), 
})
public class WindLookupMsEntity implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    final WindLookupMsEntity other = (WindLookupMsEntity) obj;
