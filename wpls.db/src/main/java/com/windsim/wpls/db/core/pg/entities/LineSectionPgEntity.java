...
@NamedQueries({
  @NamedQuery(name = "LineSectionPgEntity.findAll", query = "SELECT s FROM LineSectionPgEntity s")})
public class LineSectionPgEntity implements Serializable {
  ...
  public boolean equals(Object obj) {
    ...
    final LineSectionPgEntity other = (LineSectionPgEntity) obj;
